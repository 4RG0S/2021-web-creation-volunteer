var gameManager = (function () {
  ...
  function createCard() {
    ...
    for (i = 0; i < CARD_AMOUNT; i++) {
      $("#board").append(
        "<div onclick='' class='card col-2 col-md-2' id='card_" +
          i +
          "'>\
  ...
  function isThisPair() {
    if (cards[pick_1][1] == cards[pick_2][1]) {
      ...
      $(CARD_ID + pick_1).html(
        "<img class='card_img' src=" +
          FRONT_OF_CARD_IMG[cards[pick_1][1]] +
          " alt='카드 앞면" +
          cards[pick_1][1] +
          "'>"
      )
      $(CARD_ID + pick_2).html(
        "<img class='card_img' src=" +
          FRONT_OF_CARD_IMG[cards[pick_2][1]] +
          " alt='카드 앞면" +
          cards[pick_2][1] +
          "'>"
      )
  ...
  return {
    ...
    selectCard: function (num) {
      ...
      if (cards[num][0]) {
        ...
        // 선택한 카드가 뒷면인 경우 앞면으로 뒷면집는다.
        $(CARD_ID + num).html(
          "<img class='card_img chosen_card' src=" +
            FRONT_OF_CARD_IMG[cards[num][1]] +
            " alt='카드 앞면" +
            cards[num][1] +
            "'>"
        )
